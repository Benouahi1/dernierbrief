...
Author: Ayoub Benouahi
 
Author URI: 
 
Text Domain: Benouahifooter
...
function custom_plugin_setting_page() {
    ...
    add_menu_page('Custom Plugin', 'BFooter Setting', 'manage_options', 'custom-plugin-setting-url', 'custom_page_html_form' , plugins_url('custom-plugin/img/icon.png'));
    ...
    function custom_page_html_form() { ?>
        <div class="wrap">
            <h2>Benouahi Footer Plugin Setting</h2>
    ...
    function tryvary_include_inline_css()
{
    ...
    <style>
        .footer{
        background-color:#3582c4;color:black;display:flex;justify-content: space-between;align-items: center;padding:10px;font-family: 'Roboto',sans-serif; 
        }
        .footer-right{
